...
if isfield(data,'variance')
    data.VelocityX_var = (data.MomentumX./data.Density).^2.*(data.MomentumX_var./data.MomentumX.^2+data.Density_var./data.Density.^2) 
    data.VelocityY_var = (data.MomentumY./data.Density).^2.*(data.MomentumY_var./data.MomentumY.^2+data.Density_var./data.Density.^2) 
    data.VelocityZ_var = (data.MomentumZ./data.Density).^2.*(data.MomentumZ_var./data.MomentumZ.^2+data.Density_var./data.Density.^2) 
end
