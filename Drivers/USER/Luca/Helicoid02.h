...
class Helicoid02 : public BaseWall
{
public:
    ...
    // Copy constructor
    Helicoid02(const Helicoid02& other);

    // Good constructor
    Helicoid02(Vec3D start, Mdouble l, Mdouble R, Mdouble n, Mdouble omega, Mdouble thickness);
    
    // Destroyer
    ~Helicoid02();
    
    // Pointer to a copy of the Helicoid
    Helicoid02* copy() const final;
