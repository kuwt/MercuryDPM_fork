...
public:
    ...
    ScrewCC(Vec3D start, Mdouble l, Mdouble r1, Mdouble r0, Mdouble n, Mdouble omega, Mdouble thickness);

    // Destructor
    ~ScrewCC();

    // Pointer to a copy of the screw
    ScrewCC* copy() const final;
    ...
    // Returns the name of the object, here the string "ScrewCC".
