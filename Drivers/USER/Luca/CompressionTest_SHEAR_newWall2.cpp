...
public:
   ...
   void makeComplexPiston()
   {
      ...
      w1.addObject(Vec3D(1.0,1.0,0.0),Vec3D(-0.5*dentsThickness*constants::sqrt_2,0.0,0.0));
      w1.addObject(Vec3D(0.0,0.0,1.0),Vec3D(0.0,0.0,pistonHeight - dentsHeight));
      w1.addObject(Vec3D(-1.0,-1.0,0.0),Vec3D(0.0,0.5*dentsThickness*constants::sqrt_2,0.0));
      w1.addObject(Vec3D(-1.0,1.0,0.0),Vec3D(-dentLengthOpeningRatio*casingRadius/constants::sqrt_2,dentLengthOpeningRatio*casingRadius/constants::sqrt_2,0.0));
      w1pointer = wallHandler.copyAndAddObject(w1);

      w1B.setSpecies(speciesBig);
      w1B.addObject(Vec3D(1.0,1.0,0.0),Vec3D(-0.5*dentsThickness*constants::sqrt_2,0.0,0.0));
      w1B.addObject(Vec3D(0.0,0.0,1.0),Vec3D(0.0,0.0,pistonHeight - dentsHeight));
      w1B.addObject(Vec3D(-1.0,-1.0,0.0),Vec3D(0.0,0.5*dentsThickness*constants::sqrt_2,0.0));
      w1B.addObject(Vec3D(1.0,-1.0,0.0),Vec3D(dentLengthOpeningRatio*casingRadius/constants::sqrt_2,-dentLengthOpeningRatio*casingRadius/constants::sqrt_2,0.0));
      w1Bpointer = wallHandler.copyAndAddObject(w1B);

      w2.setSpecies(speciesBig);
      w2.addObject(Vec3D(-1.0,1.0,0.0),Vec3D(0.5*dentsThickness*constants::sqrt_2,0.0,0.0));
      w2.addObject(Vec3D(0.0,0.0,1.0),Vec3D(0.0,0.0,pistonHeight - dentsHeight));
      w2.addObject(Vec3D(1.0,-1.0,0.0),Vec3D(0.0,0.5*dentsThickness*constants::sqrt_2,0.0));
      w2.addObject(Vec3D(1.0,1.0,0.0),Vec3D(dentLengthOpeningRatio*casingRadius/constants::sqrt_2,dentLengthOpeningRatio*casingRadius/constants::sqrt_2,0.0));
      w2pointer = wallHandler.copyAndAddObject(w2);

      w2B.setSpecies(speciesBig);
      w2B.addObject(Vec3D(-1.0,1.0,0.0),Vec3D(0.5*dentsThickness*constants::sqrt_2,0.0,0.0));
      w2B.addObject(Vec3D(0.0,0.0,1.0),Vec3D(0.0,0.0,pistonHeight - dentsHeight));
      w2B.addObject(Vec3D(1.0,-1.0,0.0),Vec3D(0.0,0.5*dentsThickness*constants::sqrt_2,0.0));
      w2B.addObject(Vec3D(1.0,1.0,0.0),Vec3D(-dentLengthOpeningRatio*casingRadius/constants::sqrt_2,-dentLengthOpeningRatio*casingRadius/constants::sqrt_2,0.0));
...
int main(int argc, char *argv[])
{
   ...
   do
   {
      ...
      name.clear();
      std::cout.unsetf(std::ios::floatfield);
      name << "ShearTest_" << material << "_dentedPistonTest_muS_0.80";
