...
class Helicoid05 : public BaseWall
{
public:
    ...
    // Copy constructor
    Helicoid05(const Helicoid05& other);
    ...
    Helicoid05(Vec3D start, Mdouble l, Mdouble R, Mdouble r, Mdouble n, Mdouble omega, Mdouble thickness, bool rightHandeness);
    
    // Destructor
    ~Helicoid05();
    
    // Pointer to a copy of the screw
    Helicoid05* copy() const final;
    ...
    // Returns the name of the object, here the string "Helicoid05".
