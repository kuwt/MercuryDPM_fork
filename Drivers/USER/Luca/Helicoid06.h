...
class Helicoid06 : public BaseWall
{
public:
    ...
    // Copy constructor
    Helicoid06(const Helicoid06& other);
    ...
    Helicoid06(Vec3D start, Mdouble l, Mdouble R, Mdouble r, Mdouble n, Mdouble omega, Mdouble thickness, bool rightHandeness);
    
    // Destructor
    ~Helicoid06();
    
    // Pointer to a copy of the screw
    Helicoid06* copy() const final;
    
    // ----------   SET FUNCTIONS   ----------
    // Sets the screw parameters
    void set(Vec3D Start, Mdouble length, Mdouble bladeRadius, Mdouble shaftRadius, Mdouble numberOfTurns, Mdouble omega, Mdouble thickness, bool rightHandeness);
    ...
    // Returns the name of the object, here the string "Helicoid06".
