...
class Helicoid03 : public BaseWall
{
public:
    ...
    // Copy constructor
    Helicoid03(const Helicoid03& other);

    // Good constructor
    Helicoid03(Vec3D start, Mdouble l, Mdouble R, Mdouble n, Mdouble omega, Mdouble thickness);
    
    // Destroyer
    ~Helicoid03();
    
    // Pointer to a copy of the Helicoid
    Helicoid03* copy() const final;
