...
#ifndef ScrewTriangularSection_H
#define ScrewTriangularSection_H

#include "Walls/BaseWall.h"
#include "Math/Vector.h"
#include "Math/ExtendedMath.h"

class ScrewTriangularSection : public BaseWall
{
public:
    
    // Default (bad) constructor
    ScrewTriangularSection();
    
    // Copy constructor
    ScrewTriangularSection(const ScrewTriangularSection& other);

    // Good constructor
    ScrewTriangularSection(Vec3D start, Mdouble l, Mdouble R, Mdouble r, Mdouble n, Mdouble omega, Mdouble thickness);
    
    // Destroyer
    ~ScrewTriangularSection();
    
    // Pointer to a copy of the screw
    ScrewTriangularSection* copy() const final;
