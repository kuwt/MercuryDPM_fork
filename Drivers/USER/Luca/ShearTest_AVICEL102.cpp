...
int main(int argc, char *argv[])
{
   ...
   std::string material = "AVICEL102";
   std::string dataPointsFileNameCOMPRESSION = "Calibration_dataPoints/Calibration_dataPoints_COMPRESSION_AVICEL102___RESCALED_05.dat";
   std::string dataPointsFileNameSHEAR = "Calibration_dataPoints/Calibration_dataPoints_SHEAR_AVICEL102.dat";
