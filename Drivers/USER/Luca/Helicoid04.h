...
// In this version the helicoid has a triangular section, rather than a rectangular one.
...
class Helicoid04 : public BaseWall
{
public:
    ...
    // Copy constructor
    Helicoid04(const Helicoid04& other);

    // Good constructor
    Helicoid04(Vec3D start, Mdouble l, Mdouble R, Mdouble r, Mdouble n, Mdouble omega, Mdouble thickness);
    
    // Destroyer
    ~Helicoid04();
    
    // Pointer to a copy of the Helicoid
    Helicoid04* copy() const final;
    
    // Sets the Helicoid parameters
    void set(Vec3D Start, Mdouble length, Mdouble bladeRadius, Mdouble shaftRadius, Mdouble numberOfRevelations, Mdouble omega, Mdouble thickness);
...
private:
    ...
    Mdouble maxR_;
    // The inner radius of the Helicoid.
    Mdouble minR_;
