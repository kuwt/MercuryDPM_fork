...
BaseDoublePorosityStressStrainD::BaseDoublePorosityStressStrainD(){

    logger(DEBUG, "BaseCluster::BaseCluster() finished");
}

BaseDoublePorosityStressStrainD::BaseDoublePorosityStressStrainD(Mdouble pD, Mdouble lS, Mdouble rTS, Mdouble sFC, Mdouble bS, Mdouble sRPTS, std::string n){
...
BaseDoublePorosityStressStrainD::BaseDoublePorosityStressStrainD(Mdouble pD, Mdouble tC, Mdouble r, Mdouble rTS, Mdouble sFC, Mdouble bS, int nP, std::string n){
...
BaseDoublePorosityStressStrainD::BaseDoublePorosityStressStrainD(Mdouble pD, Mdouble lS, Mdouble rTS, Mdouble sFC, Mdouble bS, std::string n){
...
void BaseDoublePorosityStressStrainD::setupInitialConditions()
{
    // OUTPUT FILES
...
void BaseDoublePorosityStressStrainD::actionsBeforeTimeStep()
{
...
//! Damps velocities
void BaseDoublePorosityStressStrainD::actionsAfterTimeStep()
{
    dampVelocities();
}

//! Prints time and values of interest
void BaseDoublePorosityStressStrainD::printTime() const
{
...
void BaseDoublePorosityStressStrainD::dampVelocities()
{
...
void BaseDoublePorosityStressStrainD::setSpecies(){
...
void BaseDoublePorosityStressStrainD::insertParticles()
{
...
bool BaseDoublePorosityStressStrainD::particleInsertionSuccessful(int n)
{
...
void BaseDoublePorosityStressStrainD::createWalls()
{
    boundaryHandler.clear();
...
void BaseDoublePorosityStressStrainD::makeDataAnalysis()
{
...
//! Computes coordination number and overlaps
void BaseDoublePorosityStressStrainD::computeCoordinationNumberAndOverlaps()
{
...
void BaseDoublePorosityStressStrainD::computeVoidRatioAndPorosity()
{
...
//! computes stress
void BaseDoublePorosityStressStrainD::computeStress()
{
    stressXX = 0.0;
    stressYY = 0.0;
    stressZZ = 0.0;
