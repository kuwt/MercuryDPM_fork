...
private:
    ...
    void setupInitialConditions() override {
        ...
        // Strain
        isoStrainDot = -1e-6/getTimeStep(); // should be something like 1e-8/timeStep but for the first part it is set faster
    ...
    void setSpecies(){
        ...
        Mdouble loadingStiffness = 1.6e3;
