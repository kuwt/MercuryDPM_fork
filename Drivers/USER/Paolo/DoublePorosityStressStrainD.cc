...
DoublePorosityStressStrainD::DoublePorosityStressStrainD(){
...
DoublePorosityStressStrainD::DoublePorosityStressStrainD(std::vector<Mdouble> radC, std::vector<Vec3D> posC, Mdouble rExpCSIntra, Mdouble sFC, Mdouble relKt, Mdouble bSX, Mdouble bSY, Mdouble bSZ, std::string n){
    radiiCluster = radC;
...
void DoublePorosityStressStrainD::setupInitialConditions(){
...
void DoublePorosityStressStrainD::actionsAfterTimeStep(){
...
void DoublePorosityStressStrainD::printTime() const{
...
void DoublePorosityStressStrainD::setSpecies() {
...
void DoublePorosityStressStrainD::setSpecies2() {
...
void DoublePorosityStressStrainD::makeWalls(){
...
void DoublePorosityStressStrainD::makeIsoCFile() {
...
void DoublePorosityStressStrainD::makeOverlFile() {
...
void DoublePorosityStressStrainD::dampVelocities()
{
...
void DoublePorosityStressStrainD::makeDataAnalysis()
{
...
//! Computes coordination number and overlaps
void DoublePorosityStressStrainD::computeCoordinationNumberAndOverlaps()
{
...
void DoublePorosityStressStrainD::computeVoidRatioAndPorosity()
{
...
//! computes stress
void DoublePorosityStressStrainD::computeStress()
{
    stressXX = 0.0;
    stressYY = 0.0;
    stressZZ = 0.0;
...
//! Computes void dimension
void DoublePorosityStressStrainD::computeVoidDimensions()
{
    bool inserted = false;
...
bool DoublePorosityStressStrainD::particleInsertionSuccessful(Mdouble r) {
...
void DoublePorosityStressStrainD::writeOverlFile() {
...
void DoublePorosityStressStrainD::writeIsoCFile() {
...
void DoublePorosityStressStrainD::writeToIsoCFileTarget()
{
    isoCFile <<
...
void DoublePorosityStressStrainD::makeContactModelFile(){
