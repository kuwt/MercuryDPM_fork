...
class DoublePorosityStressStrainA : public Mercury3D{

public:

    DoublePorosityStressStrainA();

    DoublePorosityStressStrainA(std::vector<Mdouble> radC,std::vector<Vec3D> posC, Mdouble pDM, Mdouble ExpuSMintra, Mdouble rExpCSIntra, Mdouble sFC, Mdouble bS, std::string n);

    ~DoublePorosityStressStrainA() override;
