...
#ifndef MERCURY_BASEDOUBLEPOROSITYSTRESSSTRAIN_H
#define MERCURY_BASEDOUBLEPOROSITYSTRESSSTRAIN_H

#endif //MERCURY_BASEDOUBLEPOROSITYSTRESSSTRAIN_H
...
class BaseDoublePorosityStressStrain : public Mercury3D {

public:

    BaseDoublePorosityStressStrain();

    BaseDoublePorosityStressStrain(Mdouble pD, Mdouble lS, Mdouble rTS, Mdouble sFC, Mdouble bS, Mdouble sRPTS, std::string n);

    BaseDoublePorosityStressStrain(Mdouble pD, Mdouble tC, Mdouble r, Mdouble rTS, Mdouble sFC, Mdouble bS, int nP, std::string n);

    BaseDoublePorosityStressStrain(Mdouble pD, Mdouble lS, Mdouble rTS, Mdouble sFC, Mdouble bS, std::string n);

    ~BaseDoublePorosityStressStrain() override;
