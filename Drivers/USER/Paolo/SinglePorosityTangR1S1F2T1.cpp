...
private:
    ...
    void setupInitialConditions() override {
        ...
        readRestartFile("BaseSinglePorosityR1");
        ...
        name << "SinglePorosityTangR1S1F2T1";
        setName(name.str());
    ...
    void setSpecies(){
        ...
        Mdouble loadingStiffness = 6e2;
        Mdouble slidingFrictionCoefficient = 0.25;
        ...
        species -> setSlidingStiffness(0.25*species->getLoadingStiffness());
