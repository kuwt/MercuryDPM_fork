...
DoublePorosityStressStrainA::DoublePorosityStressStrainA(){
...
DoublePorosityStressStrainA::DoublePorosityStressStrainA(std::vector<Mdouble> radC, std::vector<Vec3D> posC, Mdouble pDM, Mdouble ExpuSMintra, Mdouble rExpCSIntra, Mdouble sFC, Mdouble bS, std::string n){
    radiiCluster = radC;
...
void DoublePorosityStressStrainA::setupInitialConditions(){
...
void DoublePorosityStressStrainA::actionsAfterTimeStep(){
...
void DoublePorosityStressStrainA::printTime() const{
...
void DoublePorosityStressStrainA::setSpecies() {
...
void DoublePorosityStressStrainA::setSpecies2() {
...
void DoublePorosityStressStrainA::makeWalls(){
...
void DoublePorosityStressStrainA::makeIsoCFile() {
...
void DoublePorosityStressStrainA::makeOverlFile() {
...
void DoublePorosityStressStrainA::dampVelocities()
{
...
void DoublePorosityStressStrainA::makeDataAnalysis()
{
...
//! Computes coordination number and overlaps
void DoublePorosityStressStrainA::computeCoordinationNumberAndOverlaps()
{
...
void DoublePorosityStressStrainA::computeVoidRatioAndPorosity()
{
...
//! computes stress
void DoublePorosityStressStrainA::computeStress()
{
    stressXX = 0.0;
    stressYY = 0.0;
    stressZZ = 0.0;
...
//! Computes void dimension
void DoublePorosityStressStrainA::computeVoidDimensions()
{
    bool inserted = false;
...
bool DoublePorosityStressStrainA::particleInsertionSuccessful(Mdouble r) {
...
void DoublePorosityStressStrainA::writeOverlFile() {
...
void DoublePorosityStressStrainA::writeIsoCFile() {
...
void DoublePorosityStressStrainA::writeToIsoCFileTarget()
{
    isoCFile <<
...
void DoublePorosityStressStrainA::makeContactModelFile(){
