...
#ifndef MERCURY_DOUBLEPOROSITYSTRESSSTRAIND_H
#define MERCURY_DOUBLEPOROSITYSTRESSSTRAIND_H

#endif //MERCURY_DOUBLEPOROSITYSTRESSSTRAIND_H
...
class DoublePorosityStressStrainD : public Mercury3D{

public:

    DoublePorosityStressStrainD();

    DoublePorosityStressStrainD(std::vector<Mdouble> radC,std::vector<Vec3D> posC, Mdouble rExpCSIntra, Mdouble sFC, Mdouble relKt, Mdouble bSX, Mdouble bSY, Mdouble bSZ, std::string n);

    ~DoublePorosityStressStrainD() override;
