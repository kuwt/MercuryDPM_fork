...
class DoublePorosityStressStrainB : public Mercury3D{

public:

    DoublePorosityStressStrainB();

    DoublePorosityStressStrainB(std::vector<Mdouble> radC,std::vector<Vec3D> posC, Mdouble pDM, Mdouble ExpuSMintra, Mdouble rExpCSIntra, Mdouble sFC, Mdouble bS, std::string n);

    ~DoublePorosityStressStrainB() override;
...
private:
    ...
    std::ofstream nonRelativeResultsFile;
    std::vector<Mdouble> results;
    std::vector<Mdouble> nonRelativeResults;
