...
class BayesianCompression : public Mercury3D {

public:

    BayesianCompression();

    BayesianCompression(Mdouble pD, Mdouble lS, Mdouble rTS, Mdouble sFC, Mdouble bS, Mdouble sRPTS, std::string n);

    BayesianCompression(Mdouble pD, Mdouble tC, Mdouble r, Mdouble rTS, Mdouble sFC, Mdouble bS, int nP, std::string n);

    BayesianCompression(Mdouble pD, Mdouble lS, Mdouble rTS, Mdouble sFC, Mdouble bS, std::string n);

    ~BayesianCompression() override;
