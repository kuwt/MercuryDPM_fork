...
public:
/* initial_poly creates the initial configuration before the 
 ...
 * In 'strain_iso', the last particle positions configuration
 ...
 * */
    ...
    void setupInitialConditions()
    {
		...
		double mass = rhop*constants::pi*mathsFunc::cubic(particleDiameter/(poly-1))/6.0;  //mass or effective mass in Mercury =/frac{2}{1/m1+1/m2}
...
int main(int argc , char *argv[] )
{
    ...
    problem.poly = 3;					//polydispersity dmax/dmin
    //! ----------------------------------------------------------------
    
    //! assign problem configuration: volume fraction and name
    
	problem.setName("SimpleShearIniSelfTest");
	problem.tmax = 0.5;
