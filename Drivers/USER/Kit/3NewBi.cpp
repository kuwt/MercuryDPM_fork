...
int main(int argc UNUSED, char *argv[] UNUSED)
{
	...
	//Set problem up
 	my_problem problem;
 	problem.setName("ed1_1");
 	problem.setTimeMax(30);


	//Set Container Geometry
 	problem.setXMax(6./1000.);
	...
	problem.set_NumberOfParticles(1);
	...
	problem.set_WallCOR(0.84); //normally 0.7
	...
	problem.set_switch_plate_amplitude(20.0,0.0/1000); //(time, new amplitude)
