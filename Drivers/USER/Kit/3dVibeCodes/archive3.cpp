...
int main()
{
  ...
  //of the driving
  problem.setBaseAmplitude(0.01);
  problem.setBaseFrequency(25.0);
  ...
  problem.setSmallParticleNumber(150);
  problem.setLargeParticleNumber(50);
  ...
  problem.setCoefficientOfRestitutionLarge(0.9);
  problem.setCoefficientOfRestitutionSmall(0.9);
  problem.setCoefficientOfRestitutionWall(0.9);
