...
int main(int argc, char *argv[])
{
	...
	problem.setName("Bidisperse_065020");
	//problem.autoNumber();
	//problem.setDrumRadius(0.125);// in meters
        problem.setDrumRadius(0.05);
	...
	problem.setFrictionCoeff(.65,.20);//(particle-wall-friction,part-part-friction)
