...
class RotatingDrum : public Mercury3D
{
	...
	void setupInitialConditions()
	{
		...
		speciesDrum->setTorsionFrictionCoefficient(0.25);
		...
		speciesS1->setTorsionFrictionCoefficient(0.25);
		...
		speciesS2->setTorsionFrictionCoefficient(0.25);
		...
		speciesDrumAndS1->setTorsionFrictionCoefficient(0.25);
		...
		speciesDrumAndS2->setTorsionFrictionCoefficient(0.25);
		...
		speciesS1AndS2->setTorsionFrictionCoefficient(0.25);
...
int main(int argc, char *argv[])
{
	...
	problem.setName("Bidisperse_TF025");
	//problem.autoNumber();
