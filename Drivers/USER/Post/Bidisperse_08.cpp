...
class RotatingDrum : public Mercury3D
{
	...
	void setupInitialConditions()
	{
		...
		speciesDrum->setRollingFrictionCoefficient(0.8);
		...
		speciesS1->setRollingFrictionCoefficient(0.8);
		...
		speciesS2->setRollingFrictionCoefficient(0.8);
		...
		speciesDrumAndS1->setRollingFrictionCoefficient(0.8);
		...
		speciesDrumAndS2->setRollingFrictionCoefficient(0.8);
		...
		speciesS1AndS2->setRollingFrictionCoefficient(.8);
