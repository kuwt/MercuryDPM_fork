...
class RotatingDrum : public Mercury3D
{
	...
	void setupInitialConditions()
	{
		...
		speciesDrum->setRollingFrictionCoefficient(0.3);
		...
		speciesS1->setRollingFrictionCoefficient(0.3);
		...
		speciesS2->setRollingFrictionCoefficient(0.3);
		...
		speciesDrumAndS1->setRollingFrictionCoefficient(0.3);
		...
		speciesDrumAndS2->setRollingFrictionCoefficient(0.3);
		...
		speciesS1AndS2->setRollingFrictionCoefficient(.3);
...
int main(int argc, char *argv[])
{
	...
	problem.setName("Bidisperse_10PolyD_rf03pp01");
	//problem.autoNumber();
	...
	problem.setFrictionCoeff(.6,.1);//(particle-wall-friction,part-part-friction)
