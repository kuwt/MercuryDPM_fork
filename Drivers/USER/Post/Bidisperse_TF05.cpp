...
class RotatingDrum : public Mercury3D
{
	...
	void setupInitialConditions()
	{
		...
		speciesDrum->setTorsionFrictionCoefficient(0.5);
		...
		speciesS1->setTorsionFrictionCoefficient(0.5);
		...
		speciesS2->setTorsionFrictionCoefficient(0.5);
		...
		speciesDrumAndS1->setTorsionFrictionCoefficient(0.5);
		...
		speciesDrumAndS2->setTorsionFrictionCoefficient(0.5);
		...
		speciesS1AndS2->setTorsionFrictionCoefficient(0.5);
...
int main(int argc, char *argv[])
{
	...
	problem.setName("Bidisperse_TF05");
	//problem.autoNumber();
