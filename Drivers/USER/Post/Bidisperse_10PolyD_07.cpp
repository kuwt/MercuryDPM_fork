...
class RotatingDrum : public Mercury3D
{
	...
	void setupInitialConditions()
	{
		...
		speciesDrum->setRollingFrictionCoefficient(0.7);
		...
		speciesS1->setRollingFrictionCoefficient(0.7);
		...
		speciesS2->setRollingFrictionCoefficient(0.7);
		...
		speciesDrumAndS1->setRollingFrictionCoefficient(0.7);
		...
		speciesDrumAndS2->setRollingFrictionCoefficient(0.7);
		...
		speciesS1AndS2->setRollingFrictionCoefficient(.7);
...
int main(int argc, char *argv[])
{
	...
	problem.setName("Bidisperse_10PolyD_07");
	//problem.autoNumber();
