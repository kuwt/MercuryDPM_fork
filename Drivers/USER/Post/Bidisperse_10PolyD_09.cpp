...
class RotatingDrum : public Mercury3D
{
	...
	void setupInitialConditions()
	{
		...
		speciesDrum->setRollingFrictionCoefficient(0.9);
		...
		speciesS1->setRollingFrictionCoefficient(0.9);
		...
		speciesS2->setRollingFrictionCoefficient(0.9);
		...
		speciesDrumAndS1->setRollingFrictionCoefficient(0.9);
		...
		speciesDrumAndS2->setRollingFrictionCoefficient(0.9);
		...
		speciesS1AndS2->setRollingFrictionCoefficient(.9);
...
int main(int argc, char *argv[])
{
	...
	problem.setName("Bidisperse_10PolyD_09");
	//problem.autoNumber();
