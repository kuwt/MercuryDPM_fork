...
class RotatingDrum : public Mercury3D
{
	...
	void setupInitialConditions()
	{
		...
		speciesDrum->setRollingFrictionCoefficient(0.45);
		...
		speciesS1->setRollingFrictionCoefficient(0.45);
		...
		speciesS2->setRollingFrictionCoefficient(0.45);
		...
		speciesDrumAndS1->setRollingFrictionCoefficient(0.45);
		...
		speciesDrumAndS2->setRollingFrictionCoefficient(0.45);
		...
		speciesS1AndS2->setRollingFrictionCoefficient(.45);
...
int main(int argc, char *argv[])
{
	...
	problem.setName("Bidisperse_10PolyD_rf045pp025");
	//problem.autoNumber();
	...
	problem.setFractionalPolydispersity(0.1);//10% dispersity
	...
	problem.setFrictionCoeff(.6,.25);//(particle-wall-friction,part-part-friction)
