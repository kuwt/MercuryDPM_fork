...
class RotatingDrum : public Mercury3D
{
	...
	void setupInitialConditions()
	{
		...
		speciesDrum->setRollingFrictionCoefficient(0.35);
		...
		speciesS1->setRollingFrictionCoefficient(0.35);
		...
		speciesS2->setRollingFrictionCoefficient(0.35);
		...
		speciesDrumAndS1->setRollingFrictionCoefficient(0.35);
		...
		speciesDrumAndS2->setRollingFrictionCoefficient(0.35);
		...
		speciesS1AndS2->setRollingFrictionCoefficient(.35);
...
int main(int argc, char *argv[])
{
	...
	problem.setName("Bidisperse_10PolyD_rf035pp015");
	//problem.autoNumber();
	...
	problem.setFrictionCoeff(.6,.15);//(particle-wall-friction,part-part-friction)
