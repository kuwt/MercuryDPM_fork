...
class RotatingDrum : public Mercury3D
{
	...
	void setupInitialConditions()
	{
		...
		speciesDrum->setRollingFrictionCoefficient(0.1);
		...
		speciesS1->setRollingFrictionCoefficient(0.1);
		...
		speciesS2->setRollingFrictionCoefficient(0.1);
		...
		speciesDrumAndS1->setRollingFrictionCoefficient(0.1);
		...
		speciesDrumAndS2->setRollingFrictionCoefficient(0.1);
		...
		speciesS1AndS2->setRollingFrictionCoefficient(.1);
...
int main(int argc, char *argv[])
{
	...
	problem.setName("Bidisperse_10PolyD_01");
	//problem.autoNumber();
