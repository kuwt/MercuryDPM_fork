...
class RotatingDrum : public Mercury3D
{
	...
	void setupInitialConditions()
	{
		...
		speciesDrum->setRollingFrictionCoefficient(0.4);
		...
		speciesDrum->setTorsionFrictionCoefficient(0.001);
		...
		speciesDrumAndS1->setRollingFrictionCoefficient(0.4);
		...
		speciesDrumAndS1->setTorsionFrictionCoefficient(0.001);
		...
		speciesDrumAndS2->setRollingFrictionCoefficient(0.4);
		...
		speciesDrumAndS2->setTorsionFrictionCoefficient(0.001);
		...
		speciesS1AndS2->setRollingFrictionCoefficient(.4);
		...
		speciesS1AndS2->setTorsionFrictionCoefficient(0.001);
...
int main(int argc, char *argv[])
{
	...
	problem.setName("Bidisperse_TF0001");
	//problem.autoNumber();
	...
	problem.setCOR(0.9,0.831,0.831);//drumWall, species1, species2
