...
class RotatingDrum : public Mercury3D
{
	...
	void setupInitialConditions()
	{
		...
		speciesDrum->setRollingFrictionCoefficient(0.6);
		...
		speciesS1->setRollingFrictionCoefficient(0.6);
		...
		speciesS2->setRollingFrictionCoefficient(0.6);
		...
		speciesDrumAndS1->setRollingFrictionCoefficient(0.6);
		...
		speciesDrumAndS2->setRollingFrictionCoefficient(0.6);
		...
		speciesS1AndS2->setRollingFrictionCoefficient(.6);
