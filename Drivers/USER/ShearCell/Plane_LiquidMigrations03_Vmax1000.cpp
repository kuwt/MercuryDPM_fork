 ...
 * */    
    ...
    {		
		...
		particleSpecies->setLiquidBridgeVolumeMax(1000e-12);
...
int main(int argc UNUSED, char *argv[] UNUSED)
{
	...
	for (BaseParticle* p : problem.particleHandler)
    {
    ...
    problem.setName("Plane_LiquidMigrations03_Vmax1000");
    problem.tmax = 50;
