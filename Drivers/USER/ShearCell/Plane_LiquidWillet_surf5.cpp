 ...
 * */    
    poly_simpleshear()
    {
        setName("Plane_shear_relax_dry");
        readRestartFile();
        setRestarted(false);
        particleSpecies = dynamic_cast<LinearViscoelasticFrictionLiquidBridgeWilletSpecies*>(speciesHandler.getObject(0));
    ...
    LinearViscoelasticFrictionLiquidBridgeWilletSpecies* particleSpecies;
    ...
    {		
		...
		particleSpecies->setLiquidBridgeVolume(75e-12);
		particleSpecies->setSurfaceTension(0.100);
...
int main(int argc UNUSED, char *argv[] UNUSED)
{
    ...
    problem.setName("Plane_LiquidWillet_surf5");
    problem.tmax = 50;
    problem.dot_strain_xy = 0.12;
