...
class AngleRepose2D : public Mercury2D
{
    public:
        AngleRepose2D(at2d_pars_t pars_in)
        {
            fprintf(stderr, "constructor for AngleRepose2D\n");
            pars = pars_in;
        ...
        double getHeapReposeAngle()
        {
            ...
            {
                SphericalParticle* p_pt = dynamic_cast<SphericalParticle*>(*it);
                SphericalParticle p=*p_pt;
