/* CMFMBlasius - As with MaserBlasius but using a ConstantMassFlowMaserBoundary for
...
class CMFMBlasius : public Mercury2D {
    public:

        /* Constructor */
        CMFMBlasius(std::string parsfile)
        {
            /* Reading config file */
...
int main(const int argc, char* argv[]) {
    ...
    if (argc > 1)
    {
        CMFMBlasius* problem = new CMFMBlasius(argv[1]);
        argv[1] = argv[0];
