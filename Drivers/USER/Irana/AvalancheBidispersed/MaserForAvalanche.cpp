...
class MaserForAvalanche : public BidispersedChute
{
public:
     ...
     */
    MaserForAvalanche(BidispersedChuteParameters parameters) :
    ...
    {
        if (!maserHasOpened && getTime() > 1000) //should be 2000
        {
...
private:
    ...
    void openMaser()
    {
        ...
        deletionBoundary.set(Vec3D(1, 0, 0), 5000);
...
int main(int argc, char* argv[])
{
    ...
    MaserForAvalanche maserForAvalanche(parameters);
