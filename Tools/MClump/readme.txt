...
'python mclump.py -m 3' compute inertia properties from stl, generate pebbles from stl
'python mclump.py -m 4' compute inertia properties from stl, load pebbles from file
