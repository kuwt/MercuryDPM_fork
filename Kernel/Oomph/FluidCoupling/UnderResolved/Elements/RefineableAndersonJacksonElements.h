...
#ifndef OOMPH_REFINEABLE_ANDERSON_JACKSON_ELEMENTS_HEADER
#define OOMPH_REFINEABLE_ANDERSON_JACKSON_ELEMENTS_HEADER
...
//Oomph-lib headers
#include "../../../../../oomph-lib/src/generic/refineable_quad_element.h"
#include "../../../../../oomph-lib/src/generic/refineable_brick_element.h"
#include "../../../../../oomph-lib/src/generic/hp_refineable_elements.h"
#include "../../../../../oomph-lib/src/generic/error_estimator.h"
...
//======================================================================
/// A class for elements that allow the imposition of Robin boundarys
...
class RefineableAndersonJacksonEquations :
...
public virtual ElementWithZ2ErrorEstimator
{
 ...
 /// \short Constructor
 RefineableAndersonJacksonEquations() :
  AndersonJacksonEquations<DIM>(),
  RefineableElement(),
 ...
 /// the member function
 /// - \c RefineableAndersonJacksonEquations::
 ...
 static void pin_redundant_nodal_pressures(const Vector<GeneralisedElement*>&
                                           element_pt)
  {
   ...
   for(unsigned e=0;e<n_element;e++)
    {
     dynamic_cast<RefineableAndersonJacksonEquations<DIM>*>(element_pt[e])->
      pin_elemental_redundant_nodal_pressure_dofs();
    }
  }
 ...
 void further_build()
  {
   ...
   RefineableAndersonJacksonEquations<DIM>* cast_father_element_pt
    = dynamic_cast<RefineableAndersonJacksonEquations<DIM>*>
   ...
   ///----------------------------------- Added by Mitchel -----------------------------------------
   /// Pointer to global voidage number
      this->Voidage_fct_pt = cast_father_element_pt->voidage_fct_pt();
    
      // For the byEl
      this->Voidage_fct_pt_byEl = cast_father_element_pt->voidage_fct_pt_byEl();
    
      // For the byEl
      this->dVoidage_dx_fct_pt_byEl = cast_father_element_pt->dvoidage_dx_fct_pt_byEl();
    
      // For the byEl
      this->dVoidage_dt_fct_pt_byEl = cast_father_element_pt->dvoidage_dt_fct_pt_byEl();
      
      this->BodyForceByCoupling_fct_pt_byEl = cast_father_element_pt->body_force_fct_pt_by_coupling();
   /// ---------------------------------------------------------------------------------------------
...
//======================================================================
template<unsigned DIM>
class RefineableAJQTaylorHoodElement :
public AJQTaylorHoodElement<DIM>,
public virtual RefineableAndersonJacksonEquations<DIM>,
...
public:
 ...
 /// \short Constructor
 RefineableAJQTaylorHoodElement() :
  RefineableElement(),
  RefineableAndersonJacksonEquations<DIM>(),
  RefineableQElement<DIM>(),
  AJQTaylorHoodElement<DIM>() {}
 ...
 unsigned nvertex_node() const
  {return AJQTaylorHoodElement<DIM>::nvertex_node();}

 /// \short Pointer to the j-th vertex node in the element
 Node* vertex_node_pt(const unsigned& j) const
  {return AJQTaylorHoodElement<DIM>::vertex_node_pt(j);}
...
/// \short The velocities are isoparametric and so the "nodes" interpolating
                                               ...
                                               face_index)
 {
  this->Pressure_advection_diffusion_robin_element_pt.push_back(
   new RefineableFpPressureAdvDiffRobinBCElement<RefineableAJQTaylorHoodElement<DIM> >(
    this, face_index));
 }
...
//=======================================================================
template<unsigned DIM>
class FaceGeometry<RefineableAJQTaylorHoodElement<DIM> >:
public virtual FaceGeometry<AJQTaylorHoodElement<DIM> >
{
  public:
 FaceGeometry() : FaceGeometry<AJQTaylorHoodElement<DIM> >() {}
};
...
//=======================================================================
template<unsigned DIM>
class FaceGeometry<FaceGeometry<RefineableAJQTaylorHoodElement<DIM> > >:
public virtual FaceGeometry<FaceGeometry<AJQTaylorHoodElement<DIM> > >
{
  public:
 FaceGeometry() : FaceGeometry<FaceGeometry<AJQTaylorHoodElement<DIM> > >()
  {}
};
...
//======================================================================
template<unsigned DIM>
class RefineableAJQCrouzeixRaviartElement :
public AJQCrouzeixRaviartElement<DIM>,
public virtual RefineableAndersonJacksonEquations<DIM>,
public virtual RefineableQElement<DIM>
{
  private:
...
public:
 ...
 /// \short Constructor
 RefineableAJQCrouzeixRaviartElement() :
  RefineableElement(),
  RefineableAndersonJacksonEquations<DIM>(),
  RefineableQElement<DIM>(),
  AJQCrouzeixRaviartElement<DIM>() {}


 /// Broken copy constructor
 RefineableAJQCrouzeixRaviartElement
  (const RefineableAJQCrouzeixRaviartElement<DIM>& dummy)
  {
   BrokenCopy::broken_copy("RefineableAJQCrouzeixRaviartElement");
  }
...
//quite rightly, it shouts.
 /*void operator=(const RefineableAJQCrouzeixRaviartElement<DIM>&)
  {
   BrokenCopy::broken_assign("RefineableAJQCrouzeixRaviartElement");
   }*/
 ...
 /// \short Number of vertex nodes in the element
 unsigned nvertex_node() const
  {return AJQCrouzeixRaviartElement<DIM>::nvertex_node();}

 /// \short Pointer to the j-th vertex node in the element
 Node* vertex_node_pt(const unsigned& j) const
  {
   return AJQCrouzeixRaviartElement<DIM>::vertex_node_pt(j);
  }
...
void get_interpolated_values(const Vector<double>&s,  Vector<double>& values)
 ...
 {
  this->Pressure_advection_diffusion_robin_element_pt.push_back(
   new RefineableFpPressureAdvDiffRobinBCElement<RefineableAJQCrouzeixRaviartElement<DIM> >(
    this, face_index));
 }
...
//======================================================================
template<unsigned DIM>
class PRefineableAJQCrouzeixRaviartElement :
public AJQCrouzeixRaviartElement<DIM>,
public virtual RefineableAndersonJacksonEquations<DIM>,
...
public:
 ...
 /// \short Constructor
 PRefineableAJQCrouzeixRaviartElement() :
  RefineableElement(),
  RefineableAndersonJacksonEquations<DIM>(),
  ...
  AJQCrouzeixRaviartElement<DIM>()
   {
    ...
    // (Constructor for AJQCrouzeixRaviartElement sets up DIM+1 pressure values)
 ...
 /// Broken copy constructor
 PRefineableAJQCrouzeixRaviartElement
  (const PRefineableAJQCrouzeixRaviartElement<DIM>& dummy)
  {
   BrokenCopy::broken_copy("PRefineableAJQCrouzeixRaviartElement");
  }

 /// Broken assignment operator
 /*void operator=(const PRefineableAJQCrouzeixRaviartElement<DIM>&)
  {
   BrokenCopy::broken_assign("PRefineableAJQCrouzeixRaviartElement");
   }*/
...
//=======================================================================
/// Face geometry of the RefineableQuadAJQCrouzeixRaviartElements
//=======================================================================
template<unsigned DIM>
class FaceGeometry<RefineableAJQCrouzeixRaviartElement<DIM> >:
public virtual FaceGeometry<AJQCrouzeixRaviartElement<DIM> >
{
  public:
 FaceGeometry() : FaceGeometry<AJQCrouzeixRaviartElement<DIM> >() {}
};

//======================================================================
/// \short Face geometry of the face geometry of
/// the RefineableAJQCrouzeixRaviartElements is the
/// same as the Face geometry of the Face geometry of
/// AJQCrouzeixRaviartElements.
//=======================================================================
template<unsigned DIM>
class FaceGeometry<FaceGeometry<RefineableAJQCrouzeixRaviartElement<DIM> > >:
public virtual FaceGeometry<FaceGeometry<AJQCrouzeixRaviartElement<DIM> > >
{
  public:
 FaceGeometry() : FaceGeometry<FaceGeometry<AJQCrouzeixRaviartElement<DIM> > >()
  {}
};
...
//=====================================================================
template<>
inline void RefineableAJQCrouzeixRaviartElement<2>::
...
//=================================================================
template<>
inline void RefineableAJQCrouzeixRaviartElement<3>::
rebuild_from_sons(Mesh* &mesh_pt)
{
...
//======================================================================
template<>
inline void RefineableAJQCrouzeixRaviartElement<2>::further_build()
{
 ...
 RefineableAJQCrouzeixRaviartElement<2>* cast_father_element_pt=
  dynamic_cast<RefineableAJQCrouzeixRaviartElement<2>*>(father_el_pt);
...
//=======================================================================
template<>
inline void RefineableAJQCrouzeixRaviartElement<3>::further_build()
{
 ...
 // Pressure value in father element
 RefineableAJQCrouzeixRaviartElement<3>* cast_father_element_pt=
  dynamic_cast<RefineableAJQCrouzeixRaviartElement<3>*>(father_el_pt);
...
//=======================================================================
template<>
inline double PRefineableAJQCrouzeixRaviartElement<2>::
...
//=======================================================================
template<>
inline double PRefineableAJQCrouzeixRaviartElement<3>::
dshape_and_dtest_eulerian_nst(const Vector<double> &s, Shape &psi,
                              DShape &dpsidx, Shape &test,
                              DShape &dtestdx) const
{
...
//=======================================================================
template<>
inline void PRefineableAJQCrouzeixRaviartElement<2>::
...
//=======================================================================
template<>
inline void PRefineableAJQCrouzeixRaviartElement<3>::
pshape_nst(const Vector<double> &s, Shape &psi) const
{
 unsigned npres = this->npres_nst();
 if (npres==1)
