...
//            logger(INFO,"Call to steady_newton_solve() with increasing fraction fo body forrce coupling");
//            int n = 10;
...
//                steady_newton_solve();
//
//                logger(INFO,"Call to steady_newton_solve() with increasing fraction fo Re");
//                int n2 = 10;
...
//            }
            ...
            unsteady_newton_solve(getTimeStepOomph());
...
void UnderResolvedCoupling::syncTimeSteps()
{
    double outputTimeStep = getTimeStepOomph()*getSaveCountOomph();
    setSaveCount(std::ceil(outputTimeStep/getTimeStep()));
...
void UnderResolvedCoupling::settleParticles()
{
    unsigned it = 0;
...
void UnderResolvedCoupling::actions_before_adapt()
{
...
// Actions after adapt, renumber elements, update lists
void UnderResolvedCoupling::actions_after_adapt()
{
...
void UnderResolvedCoupling::actionsAfterTimeStep()
{
...
void UnderResolvedCoupling::updateInteractionForces()
{
...
void UnderResolvedCoupling::updatePOnPart(const unsigned int &iPart, const int &pInEl, const double &voidInEl, const oomph::Vector<double> &s)
{
...
Vec3D UnderResolvedCoupling::getPOnPart(const unsigned int &iPart, const int &pInEl, const double &voidInEl, const oomph::Vector<double> &s)
{
    BaseParticle* particlePtr = particleHandler.getObject(iPart);
...
void UnderResolvedCoupling::updateFdOnPart(const unsigned int &iPart, const int &pInEl, const double &voidInEl, const oomph::Vector<double> &s)
{
    BaseParticle* particlePtr = particleHandler.getObject(iPart);
...
void UnderResolvedCoupling::updateShearOnPart(const unsigned int &iPart_, const int &pInEl_, const double &voidInEl_, const oomph::Vector<double> &s_)
{
...
void UnderResolvedCoupling::updateSaffmanLift(const unsigned &iPart_, const int &pInEl_, const oomph::Vector<double> &s_)
{
    BaseParticle* particlePtr = particleHandler.getObject(iPart_);
...
void UnderResolvedCoupling::updateMagnusLift(const unsigned &iPart_, const int &pInEl_, const oomph::Vector<double> &s_)
{
    BaseParticle* particlePtr = particleHandler.getObject(iPart_);
...
oomph::Vector<double> UnderResolvedCoupling::getBodyForceInElemByCoupling(const int &iEl_)
{
    Vec3D Ftotal = {0.,0.,0.};
...
void UnderResolvedCoupling::pinBC()
{
...
void UnderResolvedCoupling::setBC()
{
 ...
 * \param[in]
 */
void UnderResolvedCoupling::generateLists()
{
    setListsLengths();
    updateListOfPInElem();
 ...
 * \param[in]
 */
void UnderResolvedCoupling::updateLists()
{
    updateListOfPInElem();
    updateListOfVoidageInElem();
    updateListOfdVoidagedxInElem();
 ...
 * \param[in]
 */
void UnderResolvedCoupling::setListsLengths()
{
 ...
 * \param[in]
 */
void UnderResolvedCoupling::updateListsForSpecificParticle(const unsigned &iPart)
{
 ...
 * \param[in]
 */
void UnderResolvedCoupling::updateListOfPInElem()
{
    for (unsigned int iP = 0; iP < particleHandler.getNumberOfObjects(); iP++)
    {
 ...
 * \param[in]
 */
void UnderResolvedCoupling::updateListOfPInElem(const unsigned &iPart)
{
 ...
 * \param[in]
 */
void UnderResolvedCoupling::updateListOfVoidageInElem()
{
 ...
 * \param[in]
 */
void UnderResolvedCoupling::updateListOfVoidageInElem(const unsigned &iEl)
{
 ...
 * \param[in]
 */
void UnderResolvedCoupling::updateNeighbourList()
{
 ...
 */
void UnderResolvedCoupling::getNeighbourIndex(const int indexTree_, const int dir_, int &indexInternalNeighbour_)
{
 ...
 */
int UnderResolvedCoupling::convertIndexFromPath(std::vector<int>& indexPath, const int& differenceInLevel_, const int& dir_)
{
    int convertedIndex;
 ...
 * \param[out]
 */
void UnderResolvedCoupling::updateListOfdVoidagedxInElem()
{
 ...
 * \param[out]
 */
void UnderResolvedCoupling::updateListOfdVoidagedxAroundElem(const unsigned &iEl)
{
 ...
 * \param[out]
 */
void UnderResolvedCoupling::updateListOfdVoidagedxInElem(const unsigned &iEl)
{
    ...
    for (unsigned int iDir = 0; iDir < 3; iDir++)
    {
        ...
        dynamic_cast<RefineableAJQCrouzeixRaviartElement<3> *>(mesh_pt()->element_pt(neighbour0))->interpolated_x(s0,x0);
        ...
        dynamic_cast<RefineableAJQCrouzeixRaviartElement<3> *>(mesh_pt()->element_pt(neighbour2))->interpolated_x(s2,x2);
 ...
 * \param[out]
 */
void UnderResolvedCoupling::updateListOfdVoidagedtInElem()
{
    logger(DEBUG,"Call to updateListOfdVoidagedtInElem()");
 ...
 */
void UnderResolvedCoupling::updateListOfdVoidagedtAfterAdapt(const std::vector< std::vector<double> > &histValuesBeforeAdapt, const std::vector<double> &dVoidagedtBeforeAdapt)
{
 ...
 * \param[in]
 */
void UnderResolvedCoupling::updateHistoryValuesVoidage(const unsigned int &iEl_)
{
...
void UnderResolvedCoupling::outputNeighboursOfElements()
{
 ...
 * \param[in]
 */
void UnderResolvedCoupling::getS(oomph::Vector<double> &s_, const unsigned &iPart_, const int &pInEl_)
{
    BaseParticle* particlePtr = particleHandler.getObject(iPart_);
 ...
 */
double UnderResolvedCoupling::getInflowVel(const double &time_)
{
 ...
 * @return bool
 */
bool UnderResolvedCoupling::myHeaviSide(const double &a_, const double &b_)
{
    return b_ >= a_;
}
